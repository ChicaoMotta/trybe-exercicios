...
firstLi.addEventListener("click", boxTranslate);
secondLi.addEventListener("click", boxTranslate);
thirdLi.addEventListener("click", boxTranslate);

function boxTranslate(event) {
...
// com a classe 'tech';
input.addEventListener('keyup', rewrite)
